...
// Dynamic demo key generator — maps provider/service to realistic env var names
function generateDemoEnv(providerId) {
  ...
  return templates[key] || `${p}_API_KEY=${randHex(24)}\n${p}_PROJECT_ID=proj_${randHex(12)}`;
}
